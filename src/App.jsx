...
function App() {
  ...
  useEffect(() => {
    ...
    trailGeometry.setAttribute(
      "position",
      new THREE.BufferAttribute(trailPosition, 3)
    );
    ...
    function animate() {
      ...
      if (screen.width > 500) {
        ...
        goneText.rotation.z += 0.003;
        goneText.rotation.y = -0.003;
        goneText.rotation.x - 0.003;
      }
  ...
  return <audio id="song1" src={mmmuggers}></audio>;
}
